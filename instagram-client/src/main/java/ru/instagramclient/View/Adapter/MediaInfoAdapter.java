...
public class MediaInfoAdapter extends RecyclerView.Adapter<MediaInfoAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public View view;
        public TextView nameOwner, countLikes, countComment;
...
/*            List<Comments> listComment = mediaInfo.getListComment();
            for(int i = 0; i < listComment.size(); i++){
                TextView message = new TextView(activity);
                message.setPadding(5, 5, 5, 5);
                message.setText(mediaInfo.getListComment().get(i).getText());
                message.setTextSize(12);
                holder.layoutComment.addView(message);
            }*/
        }
        else {
